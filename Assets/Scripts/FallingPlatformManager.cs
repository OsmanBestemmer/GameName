...
public class FallingPlatformManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Instantiate(PlatformFallPrefab, new Vector2(-158f, 295f), PlatformFallPrefab.transform.rotation);
        Instantiate(PlatformFallPrefab, new Vector2(-198.8f, 318.7f), PlatformFallPrefab.transform.rotation);
        ...
        Instantiate(PlatformFallPrefab, new Vector2(231f, 313f), PlatformFallPrefab.transform.rotation);
        Instantiate(PlatformFallPrefab, new Vector2(195f, 313f), PlatformFallPrefab.transform.rotation);
